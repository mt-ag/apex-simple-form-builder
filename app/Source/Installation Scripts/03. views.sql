CREATE OR REPLACE FORCE EDITIONABLE VIEW "SFB_JSON_WITH_ATTRIBUTES_V" ("V_ROWNUM", "JSON_NAME", "JSON_ID", "FIELD_NAME", "ORIGINAL_FIELD_NAME", "ATTRIBUTE_NAME", "REQUIRED_YN", "HFAT_ID") AS 
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SFB_P0001_HELP_FORM_ATTRIBUTES_V" ("URL_LINK", "HFAT_ID", "HFAT_NAME", "HFAT_REQUIRED_YN", "HFAT_ATTR_FK", "HFAT_JASON_FK") AS 
...
left join SFB_HELP_FORM_ATTRIBUTES  
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SFB_P0001_HELP_JSON_DATA_TYPE_PROPERTIES_V" ("HJDP_ID", "HJDP_NAME", "HJDP_HFAT_FK", "HJDP_PROP_FK") AS 
  select HJDP_ID
     , HJDP_NAME
     , HJDP_HFAT_FK
     , HJDP_PROP_FK 
